...
import com.example.a20230304recyclerview.R;
...
public class MyAdatpter extends RecyclerView.Adapter<MyAdatpter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(androidx.appcompat.R.layout.support_simple_spinner_dropdown_item,parent,false);
